...
static bool IsSupportedArgument(const Argument& arg)
{
    ...
    const auto a_extent_lowest = is_same_v<tensor_layout::gemm::RowMajor, ALayout> ? KRaw : MRaw;
    const auto b_extent_lowest = is_same_v<tensor_layout::gemm::RowMajor, BLayout> ? NRaw : KRaw;
...
struct Descriptor
{
    ...
    using AGridDesc_AK0_M_AK1  = remove_cvref_t<decltype(MakeAGridDescriptor_AK0_M_AK1(ADesc{}))>;
    using BGridDesc_BK0_N_BK1  = remove_cvref_t<decltype(MakeBGridDescriptor_BK0_N_BK1(BDesc{}))>;
    using B1GridDesc_BK0_N_BK1 = remove_cvref_t<decltype(MakeB1GridDescriptor_BK0_N_BK1(B1Desc{}))>;
    ...
    constexpr Descriptor(ADesc a,
        ...
        : a_grid_desc_ak0_m_ak1{MakeAGridDescriptor_AK0_M_AK1(a)},
          ...
          is_valid{
              GridwiseGemm::CheckValidity(a_grid_desc_ak0_m_ak1,
                                          b_grid_desc_bk0_n_bk1,
                                          b1_grid_desc_bk0_n_bk1,
                                          c_grid_desc_m_n,
